 ...
 * apps (ScalableService here, GbmService in gbm-owncloud, TrService in
 ...
 * data" patterns.
 *
 * This file is INTENTIONALLY DUPLICATED across gbm-owncloud,
 * Trade-Republic-owncloud and Scalable-Capital-owncloud (same content,
 * different namespace) — three ownCloud apps can't share a class via
 * composer without an extra package; the vendored-triplet keeps each repo
 * self-contained.
 */
...
abstract class BaseOwnCloudService {
	 ...
	 *
	 * On timeout the child is SIGKILL'd and EXIT_TIMEOUT is returned.
	 *
