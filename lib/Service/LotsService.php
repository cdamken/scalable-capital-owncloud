 ...
 * persists the resulting open lots to sc_lots (replaced wholesale), and
...
use OCA\ScalableCapital\Analytics\FifoLots;
use OCA\ScalableCapital\Db\Lot;
use OCA\ScalableCapital\Db\LotMapper;
